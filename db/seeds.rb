...
Tag.create!(false: "Introverti", true: "Extraverti", question_id: Question.last)
...
Tag.create!(false: "Mojito", true: "Virgin mojito", question_id: Question.last)
...
Tag.create!(false: "Biere", true: "Vin", question_id: Question.last)
...
Tag.create!(false: "", true: "", question_id: Question.last)
...
Tag.create!(false: "Film", true: "Séries", question_id: Question.last)
...
SentenceBot.create!(false: "Plutôt home-made par ici... Healthy, vegan, yes-life etc... Vous parlez en hashtag aussi j'imagine ?", true: "Plutôt plats préparés par ici... Une bonne team de Tanguy", question_id: Question.last)
Tag.create!(false: "Home-made", true: "Plats préparés", question_id: Question.last)
...
SentenceBot.create!(false: "Les livres c'est pas votre truc ici hein ? Moi être la pour faire vous ami", true: "Vous aimez les livres ici hein ? Pour rappel ca fait pas de vous des intellectuels, prenez pas la grosse tête merci", question_id: Question.last)
Tag.create!(false: "Petit lecteur", true: "Grand lecteur", question_id: Question.last)
...
SentenceBot.create!(false: "Plutôt musées/expos par ici... un groupe de pedant parisiens ca s'annonce bien...", true: "plutot concerts/festivals par ici... Des adeptes de drogues en tout genre du coup", question_id: Question.last)
Tag.create!(false: "Musée/Expo", true: "Concert/Festival", question_id: Question.last)
...
SentenceBot.create!(false: "Je vois qu'on a un groupe d'alcoolique ici. Pourquoi pas un barathon après le beer-pong", true: "Je vois que tout le monde prefere le ping-pong à l'alcool... que des gens chiant enfait", question_id: Question.last)
Tag.create!(false: "Beer-Pong", true: "Ping-pong", question_id: Question.last)
...
SentenceBot.create!(false: "On a une team sport ici. Si quelqu'un fait plus de 100kg, on pourra faire croire que c'est du muscle", true: "je vois qu'on a une team canapé ici... Concours de graisse ? :)", question_id: Question.last)
Tag.create!(false: "Team Sport", true: "Team Canapé", question_id: Question.last)
...
SentenceBot.create!(false: "On a donc des superstitieux ici. Les cailloux magique tout ca...", true: "Que des rationnels ici, on pourrait presque croire que le QI moyen du groupe depasse les 75", question_id: Question.last)
Tag.create!(false: "Superstitieux", true: "Rationnel", question_id: Question.last)
...
SentenceBot.create!(false: "On prefere les diners plutot que sortir ici? alors comme ca on a + de 50 ans?", true: "Alors comme ca on aime se tremousser sur le dancefloor par ici ?", question_id: Question.last)
Tag.create!(false: "Dîner entre amis", true: "Sortie en boîte", question_id: Question.last)
...
SentenceBot.create!(false: "Plutot des Messi que des Nadal par ici... Enfin sur papier, en vrai on sait tous que vous valez rien", true: "Plutot des Nadal que des Messi par ici... Enfin sur papier, en vrai on sait tous que vous valez rien", question_id: Question.last)
Tag.create!(false: "Football", true: "Tennis", question_id: Question.last)
...
SentenceBot.create!(false: "Plutôt livraison à domicile par ici... Un peu de respect pour vous-meme ca vous dit ? :)", true: "Plutôt restaurant par ici... Je vois qu'on est un groupe qui a les moyens...", question_id: Question.last)
Tag.create!(false: "Livraison à domicile", true: "Restaurant", question_id: Question.last)
...
SentenceBot.create!(false: "Plutôt Breaking Bad par ici... Plus porté sur la drogue que l'heroisme enfait", true: "Plutôt Game of Thrones par ici... Enfin, plutôt pour Daenerys que pour le scenario, on est d'accord", question_id: Question.last)
Tag.create!(false: "Breaking Bad", true: "Game of Throne", question_id: Question.last)
